...
void event_warp_exec(event *p_event, game *p_game, SDL_Renderer *renderer)
{
  ...
  p_game->o_hero.p_sprite->x = p_event_param_warp->index_x * p_game->o_level.p_map->p_tileset->tile_width;
  p_game->o_hero.p_sprite->y = p_event_param_warp->index_y * p_game->o_level.p_map->p_tileset->tile_height;
